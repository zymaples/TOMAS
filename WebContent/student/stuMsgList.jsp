		...
		<table class="table table-striped">
			...
			<c:forEach var="message" items="${ list }">
				<tr align="center">
					...
					<td><a class="btn btn-primary btn-xs" href="StudentServlet?method=updateMsgUI&mid=${ message.mid }">修改</a></td>
				...
				<form  class="form-horizontal" action="StudentServlet?method=delMsg&mid=${ message.mid }" method="post">
