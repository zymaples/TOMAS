...
function checkPassword() {
	...
	$.post("/TOMAS/StudentServlet?method=checkPassword", {password:password}, function(data) {
		if (data == 0) {
...
<body>
	...
	<jsp:include page="../header.jsp"></jsp:include>
		<div style="margin: auto;">
			...
			<form class="form-horizontal col-sm-offset-3" onsubmit="return checkForm()" action="${ pageContext.request.contextPath }/StudentServlet?method=changePassword" method="post">
