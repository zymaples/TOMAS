		...
		<table class="table table-striped">
			...
			<c:forEach var="answer" items="${ list }">
				<tr align="center">
					...
					<td><a class="btn btn-danger btn-xs" href="AdminServlet?method=delAnswer&aid=${ answer.aid }">删除</a></td>
				</tr>
				...
				<form method="post" action="AdminServlet?method=updateAnswer&aid=${ answer.aid }" id="answerForm" class="form-horizontal" role="form">
